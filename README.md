# 🎮 Hi, I'm Chirag Gupta — *Developer in Progress*

```
🧑‍💻 ROLE: Software Developer
🎓 CLASS: B.Tech CSE (AI & ML)
⚡ CURRENT QUEST: Mastering DSA in C++
🤖 SIDE MISSIONS: Generative AI • Agentic AI • Full-Stack Systems
```
...
Bootstrap • TailwindCSS • React • Redux • Express.js • Flask • Jinja • JWT • NodeJS • NPM • Nodemon • Three.js • Vite • Chart.js • Streamlit

### ☁️ Cloud & Deployment

Google Cloud • Azure • Netlify • Vercel • Render • Oracle
...
NumPy • Pandas • Matplotlib • Plotly • scikit-learn • SciPy • OpenCV

### 🎒 Tools

VS Code • GitHub • Tableau • Figma • Adobe Tools • Canva • NPM • Nodemon
...
## 📊 🧬 XP Progress & Player Stats

![Stats](https://github-readme-stats.vercel.app/api?username=chiragg136\&show_icons=true\&hide_border=true\&theme=tokyonight)
![Streak](https://github-readme-streak-stats.herokuapp.com/?user=chiragg136\&theme=tokyonight\&hide_border=true)
...
⭐ **STATUS:** Grinding XP daily — building clean, scalable, and impactful software.
